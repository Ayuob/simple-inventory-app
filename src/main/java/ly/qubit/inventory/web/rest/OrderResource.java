...
import ly.qubit.inventory.repository.OrderRepository;
import ly.qubit.inventory.service.OrderService;
...
/**
 * REST controller for managing {@link ly.qubit.inventory.domain.Order}.
 */
@RestController
@RequestMapping("/api")
