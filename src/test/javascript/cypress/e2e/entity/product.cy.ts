...
describe('Product e2e test', () => {
  ...
  const productSample = { sku: 'invoice International Granite', productName: 'national Georgia synthesizing', price: 5818 };
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      ...
      cy.get(`[data-cy="productName"]`).type('Massachusetts Personal').should('have.value', 'Massachusetts Personal');

      cy.get(`[data-cy="productSize"]`).type('94269').should('have.value', '94269');
