...
public interface OrderLineRepository extends JpaRepository<OrderLine, Long> {
    ...
    @Query(
        value = "select distinct orderLine from OrderLine orderLine left join fetch orderLine.product",
    ...
    @Query("select distinct orderLine from OrderLine orderLine left join fetch orderLine.product")
