...
import ly.qubit.inventory.repository.CategoryRepository;
import ly.qubit.inventory.service.CategoryService;
...
/**
 * REST controller for managing {@link ly.qubit.inventory.domain.Category}.
 */
@RestController
@RequestMapping("/api")
