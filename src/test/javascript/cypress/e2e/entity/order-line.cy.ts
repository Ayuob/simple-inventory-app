...
describe('OrderLine e2e test', () => {
        ...
        cy.authenticatedRequest({
          ...
          cy.intercept(
            ...
            },
            {
              statusCode: 200,
              headers: {
                link: '<http://localhost/api/order-lines?page=0&size=20>; rel="last",<http://localhost/api/order-lines?page=0&size=20>; rel="first"',
              },
              body: [orderLine],
            }
  ...
  describe('new OrderLine page', () => {
    ...
    it('should create an instance of OrderLine', () => {
      ...
      cy.get(`[data-cy="price"]`).type('76995').should('have.value', '76995');
