...
import ly.qubit.inventory.repository.CustomerRepository;
import ly.qubit.inventory.service.dto.CustomerDTO;
import ly.qubit.inventory.service.mapper.CustomerMapper;
...
class CustomerResourceIT {
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.customerId(UPDATED_CUSTOMER_ID).state(UPDATED_STATE);
