...
class ProductResourceIT {
    ...
    void putExistingProduct() throws Exception {
        ...
        updatedProduct.sku(UPDATED_SKU).productName(UPDATED_PRODUCT_NAME).productSize(UPDATED_PRODUCT_SIZE).price(UPDATED_PRICE);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.sku(UPDATED_SKU).productName(UPDATED_PRODUCT_NAME).productSize(UPDATED_PRODUCT_SIZE).price(UPDATED_PRICE);
