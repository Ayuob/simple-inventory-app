...
describe('PurchaseOrderLine Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'purchase-order-line', component: PurchaseOrderLineComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.purchaseOrderLines?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to purchaseOrderLineService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPurchaseOrderLineIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPurchaseOrderLineIdentifier).toHaveBeenCalledWith(entity);
