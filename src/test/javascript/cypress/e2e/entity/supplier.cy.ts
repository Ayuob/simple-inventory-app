...
describe('Supplier e2e test', () => {
  ...
  describe('new Supplier page', () => {
    ...
    it('should create an instance of Supplier', () => {
      cy.get(`[data-cy="supplierName"]`).type('Toys').should('have.value', 'Toys');

      cy.get(`[data-cy="address"]`).type('input').should('have.value', 'input');

      cy.get(`[data-cy="city"]`).type('Brakushaven').should('have.value', 'Brakushaven');

      cy.get(`[data-cy="contactEmail"]`).type('Open-architected Leone Hat').should('have.value', 'Open-architected Leone Hat');

      cy.get(`[data-cy="contactPhone"]`).type('infrastructure Green Movies').should('have.value', 'infrastructure Green Movies');
