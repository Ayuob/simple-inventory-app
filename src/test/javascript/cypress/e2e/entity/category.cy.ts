...
describe('Category e2e test', () => {
  ...
  const categorySample = { categoryId: 75945 };
  ...
  describe('new Category page', () => {
    ...
    it('should create an instance of Category', () => {
      ...
      cy.get(`[data-cy="categoryDescription"]`).type('Harbor interface service-desk').should('have.value', 'Harbor interface service-desk');

      cy.get(`[data-cy="productLine"]`).type('Realigned Sports').should('have.value', 'Realigned Sports');
